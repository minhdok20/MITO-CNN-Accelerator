...
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN P16 [get_ports {in[0]}];  # "BTNC"
#set_property PACKAGE_PIN R16 [get_ports {in[1]}];  # "BTND"
#set_property PACKAGE_PIN N15 [get_ports {in[2]}];  # "BTNL"
#set_property PACKAGE_PIN R18 [get_ports {in[3]}];  # "BTNR"
...
## ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN F22 [get_ports {in[0]}];  # "SW0"
#set_property PACKAGE_PIN G22 [get_ports {in[1]}];  # "SW1"
#set_property PACKAGE_PIN H22 [get_ports {in[2]}];  # "SW2"
#set_property PACKAGE_PIN F21 [get_ports {in[3]}];  # "SW3"
